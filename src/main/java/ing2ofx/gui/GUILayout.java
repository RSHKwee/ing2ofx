...
//    outputPane.setColumnHeaderView(controlPanel);
    splitPane.add(controlPanel);
    // add(panel, BorderLayout.CENTER);
    controlPanel
        .setLayout(new MigLayout("", "[46px,grow][][grow][205px,grow]", "[23px][23px][23px][23px][23px][23px][][]"));

    controlPanel.setMinimumSize(new Dimension(350, 300));
    controlPanel.setPreferredSize(new Dimension(350, 290));
    ...
    controlPanel.add(chckbxConvertDecimalSeparator, "cell 0 0,alignx left,aligny top");
    ...
    controlPanel.add(chckbxAcountSeparateOFX, "cell 1 0");
    ...
    controlPanel.add(chckbxConvertDateFormat, "cell 0 1,alignx left,aligny center");
    ...
    controlPanel.add(chckbxSeperatorComma, "cell 0 2");
    ...
    controlPanel.add(chckbxOutputFileSameAsInput, "cell 0 3");
    ...
    controlPanel.add(txtOutputFilename, "cell 1 3,growx");
