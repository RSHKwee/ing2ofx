...
public class OfxDocument {
  ...
  private Transaction setXMLTransaction(OfxTransaction a_transaction) {
    ...
    accto.setAccountNumber(kwee.ing2ofx.ofxLibrary.OfxFunctions.getAccountTo(a_transaction));
    accto.setBankId(kwee.ing2ofx.ofxLibrary.OfxFunctions.getAccounttoBIC(a_transaction));
