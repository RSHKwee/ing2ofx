...
public class Ing2OfxStringConversion implements StringConversion {
  ...
  public Ing2OfxStringConversion() {
    LOGGER.log(Level.INFO, "Ing2OfxStringConversion");
    gmtTimeZone = TimeZone.getTimeZone("CET");
  }

  public Ing2OfxStringConversion(String cet) {
    LOGGER.log(Level.INFO, "Ing2OfxStringConversion");
    gmtTimeZone = TimeZone.getTimeZone(cet);
  }
