...
@XmlType(name = "AccountStatement2", propOrder = { "id", "elctrncSeqNb", "lglSeqNb", "creDtTm", "frToDt", "cpyDplctInd",
    "rptgSrc", "acct", "rltdAcct", "intrst", "bal", "txsSummry", "ntry", "addtlStmtInf" })
public class AccountStatement2 {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link CashBalance3
   * }
   * 
   * 
   */
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ReportEntry2
   * }
   * 
   * 
   */
