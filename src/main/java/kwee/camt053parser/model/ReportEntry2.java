...
@XmlType(name = "ReportEntry2", propOrder = { "ntryRef", "amt", "cdtDbtInd", "rvslInd", "sts", "bookgDt", "valDt",
    "acctSvcrRef", "avlbty", "bkTxCd", "comssnWvrInd", "addtlInfInd", "amtDtls", "chrgs", "techInptChanl", "intrst",
...
public class ReportEntry2 {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link EntryDetails1
   * }
   * 
   * 
   */
